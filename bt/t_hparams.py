...
class Hparams:
    ...
    # prepro 1198956
    parser.add_argument('--cn_vocab_size', default=36251, type=int)
    parser.add_argument('--en_vocab_size', default=26878, type=int)
    ...
    parser.add_argument('--maxlen1', default=209, type=int,
                        help="maximum length of a source sequence")
    parser.add_argument('--maxlen2', default=371, type=int, 
